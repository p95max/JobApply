...
sudo systemctl enable --now jobapply-backup.timer jobapply-neon-sync.timer jobapply-demo-cleanup.timer jobapply-ai-usage-digest.timer jobapply-client-digest.timer
