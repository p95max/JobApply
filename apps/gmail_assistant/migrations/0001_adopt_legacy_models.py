"""Adopt Gmail Assistant tables that were originally created in gmail_stats.

Only Django's migration state changes here. The three legacy tables and their
rows keep their original names, so production data is neither copied nor
recreated during the app split.
"""
        ...
        migrations.SeparateDatabaseAndState(
            ...
            state_operations=[
                migrations.CreateModel(
                    ...
                    options={"db_table": "gmail_stats_gmailanalysis"},
                ),
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ("created_at", models.DateTimeField(auto_now_add=True)),
                        ("updated_at", models.DateTimeField(auto_now=True)),
                        ("analysis", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="proposals", to="gmail_assistant.gmailanalysis")),
                    ...
                    options={"db_table": "gmail_stats_applicationupdateproposal"},
                ),
                migrations.CreateModel(
                    ...
                    options={"db_table": "gmail_stats_gmailassistantsettings"},
                ),
