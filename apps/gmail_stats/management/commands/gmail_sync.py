...
class Command(BaseCommand):
    help = "Sync Gmail messages and analyze application updates."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--reanalyze-existing",
            action="store_true",
            help="Analyze already cached Gmail messages again (deduplicated proposals are preserved).",
        )
    ...
    def handle(self, *args, **opts):
        ...
        result = sync_gmail_messages_for_user(
            ...
            reanalyze_existing=opts["reanalyze_existing"],
        )
